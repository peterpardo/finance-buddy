                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    ...
                                                    >
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="me-2 text-info" style="width:1rem;" viewBox="0 0 20 20" fill="currentColor">
                                                ...
                                                <li>
                                                    <form method="POST" action="/delete-finance/{{ $finance->id }}">
                                                        ...
                                                        <a 
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="me-2 text-danger" style="width:1rem;" viewBox="0 0 20 20" fill="currentColor">
