@php
$finances = DB::table('finance')->orderBy('created_at', 'desc')->get();
$totalIncome = DB::table('finance')->where('type', "income")->sum('amount');
$totalExpense = DB::table('finance')->where('type', "expense")->sum('amount');
@endphp
...
@section('content')
    ...
    <div class="container postion-relative p-sm-5">
        {{-- Income/Expense/Total --}}
        <div class="d-inline d-md-flex mt-3 justify-content-center align-items-center text-center">
        ...
        <div class="modal fade" id="addFinanceModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <form class="modal-body" id="add-finance-form">
                        ...
                        <div id="success-alert"
                            class="alert alert-dismissible alert-success d-flex align-items-center fade show d-none"
                            role="alert">
