            ...
            <form method="POST" action="{{ route('register') }}" style="width: 23rem;">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="fname" class="form-control @error('fname') is-invalid @enderror" id="fname"
                        aria-describedby="first name" value="{{ old('fname') }}" autocomplete="none">
                    @error('fname')
                ...
                <div class="mb-2">
                    ...
                    <input type="text" name="lname" class="form-control @error('lname') is-invalid @enderror" id="lname"
                        aria-describedby="last name" value="{{ old('lname') }}" autocomplete="none">
                    @error('lname')
                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-2">
                    ...
                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"
                        id="email" aria-describedby="email" value="{{ old('email') }}" autocomplete="none">
                    @error('email')
                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                    @enderror
                </div>
